...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] flag;
    TextView txt,cansayisi;
    Vibrator zong;
    ImageView cop1,cop2,cop3,cop4;
    private ImageView can1;
    public int value,btn_num,convert,skor,b,h,a,yy,intvibrate,ll,hh;
    Sessionsounds sessionsounds;
    SessionVibrate sessionVibrate;
    private int can,language_deger;
    private String st_can;
    private String d_flag,country,country1,country2,country3,country4;
    private Button op_1,op_2,op_3,op_4;
    TextView skor1,txt_oyuncuskor,isim1,isim2,isim3,isim4,zaman;
    private CountDownTimer  countDownTimer,bekletme,d_bekletme;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(language_deger == 1){
            flag= new String[]{"Almanya", "İspanya", "Portekiz", "Belçika", "Hollanda", "Lüksemburg", "Fransa", "Rusya",
            ...
            flag= new String[]{"Germany", "Spain", "Portugal", "Belgium", "Netherlands", "Luxembourg", "France", "Russia",
                    ...
                    "Iran", "Uzbekistan", "Tajikistan", "Kazakhstan", "Mexico", "Italy", "Bulgaria", "Hungary",
        ...
        //ayarlama kısmı buton
        txt=findViewById(R.id.flag_name);
        cansayisi=findViewById(R.id.cansayisi);
        op_1=findViewById(R.id.op_1);op_2=findViewById(R.id.op_2);
        op_3=findViewById(R.id.op_3);op_4=findViewById(R.id.op_4);
        //isimler...
        isim1=findViewById(R.id.isim1);isim2=findViewById(R.id.isim2);
        isim3=findViewById(R.id.isim3);isim4=findViewById(R.id.isim4);
        ...
        st_can=String.valueOf(can);
        cansayisi.setText(st_can);
        questgenerator(); //gelecek sorunun belirlenmesi
        op_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(d_flag.contains(country) && btn_num == 1){
                    ...
                    op_1.setClickable(false);op_2.setClickable(false);
                    op_3.setClickable(false);op_4.setClickable(false);
                    skor++; txt_oyuncuskor.setText(String.valueOf(skor)); //true answer...
                    countDownTimer.cancel();
                    ...
                    if(can ==5){
                        ...
                        bekletme= new CountDownTimer(2500, 1000) {
                            @Override
                            public void onTick(long millisUntilFinished) {
                            }
                            @Override
        ...
        op_4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(d_flag.contains(country) && btn_num==4){
                    ...
                    cop4.setVisibility(View.VISIBLE); op_4.getBackground().setAlpha(64); // 25% transparent
                    op_1.setClickable(false);op_2.setClickable(false);
                    op_3.setClickable(false);op_4.setClickable(false);
                    skor++; txt_oyuncuskor.setText(String.valueOf(skor)); //true answer..
                    countDownTimer.cancel();
    ...
    public void questgenerator(){
        if(convert == 25){
            ...
            Intent intent1=new Intent(MainActivity.this,game_result.class);
            intent1.putExtra("ss1",s_skor);
            intent1.putExtra("soundvalue",sound);finish();
            startActivity(intent1);
        }
        ll=ll+2;hh=hh+2;
        convert++; //game counter
       // Toast.makeText(getApplicationContext(),String.valueOf(convert), Toast.LENGTH_SHORT).show();
        skor1.setText(String.valueOf(convert));
        op_1.setClickable(true);op_2.setClickable(true);
        op_3.setClickable(true);op_4.setClickable(true); //yeniden tıklanması için
        cop1.setVisibility(View.INVISIBLE);cop2.setVisibility(View.INVISIBLE);
        cop3.setVisibility(View.INVISIBLE);cop4.setVisibility(View.INVISIBLE); //doğru cevap gizlendi tekrar...
        op_1.setBackgroundResource(android.R.color.transparent);op_2.setBackgroundResource(android.R.color.transparent);
        op_3.setBackgroundResource(android.R.color.transparent);op_4.setBackgroundResource(android.R.color.transparent);
        /*op_1.setBackgroundResource(0);op_2.setBackgroundResource(0);
        op_3.setBackgroundResource(0);op_4.setBackgroundResource(0); //arka plan resetlendi...*/
        txt.setText("");country1="";country2="";country3="";country4="";
    ...
    public  void soru_getir(){
        ...
        if(h==0){
            ...
            f.put(country1,R.drawable.germany);
            f.put(country2,R.drawable.spain);
            f.put(country3,R.drawable.belgium);
            f.put(country4,R.drawable.portugal);
            for(Map.Entry<String, Integer> entry: f.entrySet()){
                ...
                if(!key.contains(country) ){
                    if(x<3) {
                        if (c == 0) {
                            op_1.setBackgroundResource(value);op_1.setClickable(true);isim1.setText(key);
                        } else if (c == 1) {
                            op_2.setBackgroundResource(value);op_2.setClickable(true);isim2.setText(key);
                        } else if (c == 2) {
                            op_3.setBackgroundResource(value);op_3.setClickable(true);isim3.setText(key);
                        } else if (c == 3) {
                            op_4.setBackgroundResource(value);op_4.setClickable(true);isim4.setText(key);
                        }
                    }
                    x++;
                }
                    ...
                    if(c==0){
                        op_1.setBackgroundResource(value);
                        d_flag=key;
                        btn_num=1;op_1.setClickable(true);
                    }
                    else if(c==1){
                        op_2.setBackgroundResource(value);
                        d_flag=key;
                        btn_num=2;op_2.setClickable(true);
                    }
                    else if(c==2){
                        op_3.setBackgroundResource(value);
                        d_flag=key;
                        btn_num=3;op_3.setClickable(true);
                    }
                    else if(c==3){
                        op_4.setBackgroundResource(value);
                        d_flag=key;
            ...
            f1.put(country1,R.drawable.france);
            f1.put(country2,R.drawable.russia);
            f1.put(country3,R.drawable.luxembourg);
            f1.put(country4,R.drawable.netherlands);
            ...
            f3.put(country1,R.drawable.turkey);
            f3.put(country2,R.drawable.singapore);
            f3.put(country3,R.drawable.tunisia);
            f3.put(country4,R.drawable.azerbaijan);
            ...
            List<Integer> num=new ArrayList<Integer>();
            HashMap<String,Integer> f =new HashMap<String,Integer>();
            f.put(country1,R.drawable.argentina);
            f.put(country2,R.drawable.brazil);
            f.put(country3,R.drawable.uruguay);
            f.put(country4,R.drawable.colombia);
            for(Map.Entry<String, Integer> entry: f.entrySet()){
                String key = entry.getKey();value = entry.getValue();
                int c=0;c=rnd.nextInt(4-0) + 0;
                while(num.contains(c)){c=rnd.nextInt(4-0) + 0;}
                num.add(c);
                if(!key.contains(country) ){
                    if(x<3) {
                        if (c == 0) {
            ...
            List<Integer> num1=new ArrayList<Integer>();
            HashMap<String,Integer> f1 =new HashMap<String,Integer>();
            f1.put(country1,R.drawable.china); f1.put(country2,R.drawable.abd);
            f1.put(country3,R.drawable.japan);f1.put(country4,R.drawable.southkorea);
            for(Map.Entry<String, Integer> entry: f1.entrySet()){
                String key = entry.getKey();
                value = entry.getValue();
                int c=0;
            ...
            f2.put(country1,R.drawable.saudiarabia);f2.put(country2,R.drawable.uk);
            f2.put(country3,R.drawable.canada);f2.put(country4,R.drawable.china);
            ...
            if(language_deger == 1){
                ...
                country1="Iran";country2="Uzbekistan";country3="Tajikistan";country4="Kazakhstan";
            }
            List<Integer> num3=new ArrayList<Integer>();
            HashMap<String,Integer> f3 =new HashMap<String,Integer>();
            ...
            if(language_deger ==1){
                country1="Finlandiya";country2="Gana";country3="Sri Lanka";country4="Afganistan";
            }
            else{
                country1="Finland";country2="Ghana";country3="Sri Lanka";country4="Afghanistan";
            }
            List<Integer> num9=new ArrayList<Integer>();
            HashMap<String,Integer> f9 =new HashMap<String,Integer>();
            f9.put(country1,R.drawable.finland);f9.put(country2,R.drawable.ghana);
            f9.put(country3,R.drawable.srilanka);f9.put(country4,R.drawable.afghanistan);
            for(Map.Entry<String, Integer> entry: f9.entrySet()){
                ...
                if(!key.contains(country) ){
                    ...
                    if(c==0){
                        ...
                        d_flag=key;
                        btn_num=4;op_4.setClickable(true);}}}
            //Toast.makeText(getApplicationContext(),String.valueOf(d_flag), Toast.LENGTH_SHORT).show();
        }
        else if(h==13){
            if(language_deger == 1){
                country1="Avusturya";country2="Letonya";country3="Endonezya";country4="Polonya";
            }
            else{
                country1="Austria";country2="Latvia";country3="Indonesia";country4="Poland";
            }
            List<Integer> num1=new ArrayList<Integer>();
            HashMap<String,Integer> f1x =new HashMap<String,Integer>();
            f1x.put(country1,R.drawable.austria);f1x.put(country2,R.drawable.latvia);
            f1x.put(country3,R.drawable.indonesia);f1x.put(country4,R.drawable.poland);
            for(Map.Entry<String, Integer> entry: f1x.entrySet()){
                String key = entry.getKey();
                value = entry.getValue();
                int c=0;
                c= rnd.nextInt(4 - 0);
            ...
            List<Integer> num23=new ArrayList<Integer>();
            HashMap<String,Integer> f23 =new HashMap<String,Integer>();
            f23.put(country1,R.drawable.morocco);f23.put(country2,R.drawable.turkey);
            f23.put(country3,R.drawable.tunisia);f23.put(country4,R.drawable.mongolia);
            for(Map.Entry<String, Integer> entry: f23.entrySet()){
                String key = entry.getKey();
                value = entry.getValue();
                int c=0;
                c=rnd.nextInt(4-0) + 0;
                while(num23.contains(c)){c=rnd.nextInt(4-0) + 0; }
                num23.add(c);
                if(!key.contains(country) ){
                    if(x<3) {
                        if (c == 0) {
            ...
            List<Integer> num25=new ArrayList<Integer>();
            HashMap<String,Integer> f25 =new HashMap<String,Integer>();
            f25.put(country1,R.drawable.southafrica); f25.put(country2,R.drawable.tanzania);
            f25.put(country3,R.drawable.philippines);f25.put(country4,R.drawable.easttimor);
            for(Map.Entry<String, Integer> entry: f25.entrySet()){
                String key = entry.getKey();
                value = entry.getValue();
                int c=0;
                c=rnd.nextInt(4-0) + 0;
                while(num25.contains(c)){c=rnd.nextInt(4-0) + 0; }
                num25.add(c);
                if(!key.contains(country) ){
                    if(x<3) {
                        if (c == 0) {
            ...
            f26.put(country1,R.drawable.papuanewguinea);f26.put(country2,R.drawable.angola);
            f26.put(country3,R.drawable.uganda);f26.put(country4,R.drawable.libya);
            ...
            f27.put(country1,R.drawable.puertorico);f27.put(country2,R.drawable.malasya);
            f27.put(country3,R.drawable.cuba);f27.put(country4,R.drawable.costarica);
            ...
            List<Integer> num28=new ArrayList<Integer>();
            HashMap<String,Integer> f28 =new HashMap<String,Integer>();
            f28.put(country1,R.drawable.jamaica);f28.put(country2,R.drawable.bangladesh);
            f28.put(country3,R.drawable.nigeria);f28.put(country4,R.drawable.myanmar);
            for(Map.Entry<String, Integer> entry: f28.entrySet()){
                String key = entry.getKey();
                value = entry.getValue();
                int c=0;
                c=rnd.nextInt(4-0) + 0;
                while(num28.contains(c)){c=rnd.nextInt(4-0) + 0; }
                num28.add(c);
                if(!key.contains(country) ){
                    if(x<3) {
                        if (c == 0) {
            ...
            f29.put(country1,R.drawable.bolivia);f29.put(country2,R.drawable.ethiopia);
            f29.put(country3,R.drawable.zambia);f29.put(country4,R.drawable.gabon);
            ...
            f30.put(country1,R.drawable.cameroon);f30.put(country2,R.drawable.benin);
            f30.put(country3,R.drawable.madagascar);f30.put(country4,R.drawable.kenya);
