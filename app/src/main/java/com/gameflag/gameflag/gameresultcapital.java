                    ...
                    public void onResponse(String response) {
                        try {
                            if(response.contains("0")){
                                ...
                                skorgetir("0");
                                Toast.makeText(gameresultcapital.this, "Kayıt Başarılı", Toast.LENGTH_SHORT).show();
                                closeKeyBoard();}
                            else{
                    ...
                    public void onResponse(String response) {
                        try {
                            if(response.contains("0")){
                                ...
                                Toast.makeText(gameresultcapital.this, "İşlem Başarız Oldu :((", Toast.LENGTH_SHORT).show();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            Toast.makeText(gameresultcapital.this, "HATA!!"+e.toString(), Toast.LENGTH_SHORT).show();
